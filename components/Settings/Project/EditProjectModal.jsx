...
export default function EditProjectModal({ props }) {
  ...
  useEffect(() => {
    if (data?.currentProjects && projectAlias) {
      ...
      setValue('alias', selectedProject.alias);
      setValue('startDate', selectedProject.startDate);
      setValue('endDate', selectedProject.endDate);
      setValue('teamInCharge', selectedProject.teamInCharge);
      setValue('scale', selectedProject.scale);

      setValue('mpePlanned', selectedProject.mpePlanned);
      setValue('cpePlanned', selectedProject.cpePlanned);
      setValue('dtePlanned', selectedProject.dtePlanned);
      setValue('otePlanned', selectedProject.otePlanned);
      setValue('mePlanned', selectedProject.mePlanned);
      setValue('aePlanned', selectedProject.aePlanned);

      setValue('note', selectedProject.note);

    }
  }, [projectAlias])

  const onValid = (validForm) => {
    if (editProjectLoading) return;
